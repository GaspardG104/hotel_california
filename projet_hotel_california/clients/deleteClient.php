...
//Vérifier si le client est utilisée dans des réservations
...
<body>
    ...
    <div class="container">
        ...
        <div class="warning-box">
            <p><strong>Attention :</strong> Vous êtes sur le point de supprimer le client numéro <?= htmlspecialchars($client['nom']) ?>.</p>
        </div>
        
        <?php if ($hasReservations): ?>
            <div class="danger-box">
                <p><strong>Ce client est associée à <?= $count ?> réservation(s).</strong></p>
